...
function create_line(katman_name){
    ...
    if ((typeof window[name])!=="object"){
        document.getElementById('sayfamesajlari').innerText="Line Layer Created\n"+name;//sayfa mesajlarında objenin oluştuğuna dair bilgi
        var noktalar = []
        var asd
        ...
        koordinatgir.innerText="Create by Entering Coordinates"
        koordinatgir.onclick=function koordinat_gir(){
          map.off("click")
          sayfamesajlari.innerHTML=""
          sayfamesajlari.innerText="You can start drawing by entering coordinates."
          var bitirbuton = document.createElement("button")
          bitirbuton.innerText="Finish Geometry Drawing"
          bitirbuton.onclick=async function(){
              ...
              try{
              map.removeLayer(asd)
              var name2 = "line"+(new Date()).getMilliseconds()+Math.floor(Math.random()*1000);//benzersiz obje id alma
              ...
              sayfamesajlari.innerText=name2+"object created."
              await sleep(500)
            }
              catch{
          ...
          kapatbuton.onclick=function(){
            ...
            sayfamesajlari.innerHTML="Process completed"
      ...
      sayfamesajlari.innerText="You Can Continue Drawing."
      var noktalar = []
      var asd
      if (noktalar.length===0){
        ...
        var bitirbuton = document.createElement("button")
        bitirbuton.innerText="Finish Object Drawing"
        bitirbuton.onclick=function(){
          map.off("click")
          if (noktalar.length===0){
            gecici_mousemove_durumu="kapalı"
...
className	String	''	Custom class name set on an element. */
    ...
    objeyiyenile(){ //bazı durumlarda objelerde değişiklik yaplabilmesi için obje haritadan kaldırılıp tekrar eklenecek
      ...
      katmanduzenle(x){
        ...
        islem1.onclick = function objesecmek(){
          ...
          window[x].tum_ozellikler.featuregroup.on('click',function secilmisobje(e,b){
            try{ara_noktalar.off("click")}catch{}
            try{map.removeLayer(ara_noktalar)}catch{}
            try{kose_noktalari.off("click")}catch{}
          ...
          if (0<= o &&  o < window[x].tum_ozellikler.objeler["'"+secilen_obje.obje+"'"].geometrioznitelik.geometry.coordinates.length-1){
            ara_noktalistesi.push({
                              ...
                              window["ara"+o] = L.geoJSON({type:"Feature","geometry":{"type":"Point","coordinates":[(window[x].tum_ozellikler.objeler["'"+secilen_obje.obje+"'"].geometrioznitelik.geometry.coordinates[parseFloat(o)+1][0] + window[x].tum_ozellikler.objeler["'"+secilen_obje.obje+"'"].geometrioznitelik.geometry.coordinates[o][0])/2,(window[x].tum_ozellikler.objeler["'"+secilen_obje.obje+"'"].geometrioznitelik.geometry.coordinates[parseFloat(o)+1][1] + window[x].tum_ozellikler.objeler["'"+secilen_obje.obje+"'"].geometrioznitelik.geometry.coordinates[o][1])/2]}},
            {pointToLayer:function(feature,latlng){
            ...
            nokta_ekle.innerText="Add Midpoint"
            ...
            kose_kaydir.innerText="Vertex Shift"
            kose_kaydir.onclick=function(){
              ...
              kose_noktalari.on("click",function(asd){
                ...
                var secilen_kose = asd.layer.feature.geometry.coordinates
                  ...
                  if (window[x].tum_ozellikler.objeler["'"+secilen_obje.obje+"'"].geometrioznitelik.geometry.coordinates.includes(secilen_kose)){
                              var indexxx= window[x].tum_ozellikler.objeler["'"+secilen_obje.obje+"'"].geometrioznitelik.geometry.coordinates.indexOf(secilen_kose)
                              ...
                              map.on("mousemove",function onizleme(xxx){
                                      ...
                                      window[x].tum_ozellikler.featuregroup.removeLayer(window[x].tum_ozellikler.objeler["'"+secilen_obje.obje+"'"].feature)
                                      window[x].tum_ozellikler.objeler["'"+secilen_obje.obje+"'"].geometrioznitelik.geometry.coordinates.splice(indexxx,0,gecici_koordinatlar)
                                      var line = [{
                                        "type":"LineString",
                                        "coordinates":window[x].tum_ozellikler.objeler["'"+secilen_obje.obje+"'"].geometrioznitelik.geometry.coordinates
                                      }]
                                    ...
                                    map.on("click", function (xcv){
                                      ...
                                      map.off("mousemove",onizleme)
                                      var new_koordinat = [xcv.latlng.lng ,  xcv.latlng.lat]
                                      window[x].tum_ozellikler.objeler["'"+secilen_obje.obje+"'"].geometrioznitelik.geometry.coordinates.splice(indexxx,1,new_koordinat)
                                      window[x].tum_ozellikler.objeler["'"+secilen_obje.obje+"'"].feature=L.geoJSON(window[x].tum_ozellikler.objeler["'"+secilen_obje.obje+"'"].geometrioznitelik,{
                                        style: window[x].tum_ozellikler.objeler["'"+secilen_obje.obje+"'"].bicim.bicim
                                    }).addTo( window[x].tum_ozellikler.featuregroup)
                                        map.off("click")
        ...
        islem2.onclick=function objesilme(){
          ...
          for (var op in window[x].tum_ozellikler.objeler["'"+object_id+"'"].geometrioznitelik.geometry.coordinates){
            var latt = window[x].tum_ozellikler.objeler["'"+object_id+"'"].geometrioznitelik.geometry.coordinates[op][0]
            var lngg=window[x].tum_ozellikler.objeler["'"+object_id+"'"].geometrioznitelik.geometry.coordinates[op][1]
            window[x].tum_ozellikler.coordinats.splice(window[x].tum_ozellikler.coordinats.indexOf([lngg,latt],1))
          }
        ...
        islem3.onclick = function objeekle(name){
          ...
          document.getElementById('sayfamesajlari').style.backgroundColor  = "black";  
          sayfamesajlari.innerText="Can start drawing"
          var noktalar = []
      var asd
      if (noktalar.length===0){
        var stylee = {
      ...
      stildegistirme(class_id){
            ...
            secilen_objeler=xxx
                            ...
                            sayfamesajlari.appendChild(document.createElement("br"))
                                      ...
                                      tumuaynitip.onclick=function(){
                                        ...
                                        renksecimlabel.innerText="Select Color and Click 'Apply' button to apply."
                                        ...
                                        renkalmabuton.setAttribute("value","Apply")
                                        ...
                                        buyukluksecimlabel.innerText="Enter the Thickness of the Line."
                                        ...
                                        buyuklukalbuton.setAttribute("value","Apply")
                                        ...
                                        saydamlikbuton.setAttribute("value","Apply");
                                          ...
                                          if (v<2){}
                                            ...
                                            buton.onclick=function(){
                                              ...
                                              buyuklugegore.onclick= function(){
                                                ...
                                                baslangicbuyukluklabel.innerText="Enter the Initial Size."
                                                ...
                                                bitisbuyukluklabel.innerText="Enter the End Size."
                                                  ...
                                                  for (i in range(1,sinifsayisi)){
                                                    ...
                                                    if (window[class_id].tum_ozellikler.kolon_ve_tipleri[nitelik[v]]==="text"){
                                                      ...
                                                      for (var c in secilen_objeler){
                                                        ...
                                                        for (var d in Object.keys(puanlirenk)){
                                                          if (obje_puan>puanlirenk[Object.keys(puanlirenk)[d]].baslangic && obje_puan<=puanlirenk[Object.keys(puanlirenk)[d]].bitis){
                                                            window[class_id].tum_ozellikler.objeler["'"+id_no+"'"].bicim.bicim.opacity=parseFloat(Object.keys(puanlirenk)[d])
        ...
        tumunusec.innerText="Seelct All"
